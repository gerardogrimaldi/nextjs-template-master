      ...
      <Container>
        <form className={classes.formControl}>
          <Grid container spacing={3}>
            ...
            <Grid item xs={6}>
              <InputLabel id="demo-simple-select-helper-label" className={classes.inputLabel}>Nombre</InputLabel>
            ...
            <Grid item xs={6}>
              <InputLabel id="demo-simple-select-helper-label3" className={classes.inputLabel}>Club Actual</InputLabel>
              <Select
            ...
            <Grid item xs={6}>
              <InputLabel id="demo-simple-select-helper-label4" className={classes.inputLabel}>Peso</InputLabel>
              <Input
            ...
            <Grid item xs={12}>
              <InputLabel id="demo-simple-select-helper-label4" className={classes.inputLabel}>Ofrecido a:</InputLabel>
              <TextareaAutosize aria-label="minimum height" className={classes.textArea} rowsMin={4} placeholder="" />
            </Grid>
            <Grid item xs={12}>
