      ...
      <Container>
        <FormControl className={classes.formControl}>
          <Grid container spacing={3}>
            ...
            <Grid item xs={6}>
              <FormControlLabel
                control={<Checkbox checked={false} onChange={handleChange} name="comunitario" />}
                label="Comunitario"
              />
              <FormControlLabel
                control={<Checkbox checked={false} onChange={handleChange} name="compartido" />}
                label="Compartido"
              />
              {/* <Paper className={classes.paper}>xs=6</Paper> */}
            </Grid>
